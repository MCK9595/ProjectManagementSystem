...
public class OrganizationService : IOrganizationService
{
    ...
    public async Task<OrganizationDto?> GetOrganizationByIdAsync(int id, int userId)
    {
    ...
    public async Task<OrganizationDto?> UpdateOrganizationAsync(int id, UpdateOrganizationDto updateDto, int userId)
    {
        var organization = await _context.Organizations
            .Include(o => o.Members)
    ...
    public async Task<bool> DeleteOrganizationAsync(int id, int userId)
    {
        var organization = await _context.Organizations
            .Include(o => o.Members)
            .FirstOrDefaultAsync(o => o.Id == id && o.IsActive);
    ...
    public async Task<bool> CanUserAccessOrganizationAsync(int organizationId, int userId)
    {
    ...
    public async Task<string?> GetUserRoleInOrganizationAsync(int organizationId, int userId)
    {
